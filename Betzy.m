...
app.AvailableBeatmapsListBox.Items = "(No Beatmaps Available)";
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create Image5
            app.Image5 = uiimage(app.HowToPlay);
            app.Image5.ScaleMethod = 'fill';
            app.Image5.Position = [2 0 618 437];
            app.Image5.ImageSource = fullfile(pathToMLAPP, 'HTPbackground.png');

            % Create Image6
            app.Image6 = uiimage(app.HowToPlay);
            app.Image6.ScaleMethod = 'fill';
            app.Image6.Position = [72 327 480 78];
            app.Image6.ImageSource = fullfile(pathToMLAPP, 'instructions.png');

            % Create Image7
            app.Image7 = uiimage(app.HowToPlay);
            app.Image7.ImageClickedFcn = createCallbackFcn(app, @Image7Clicked, true);
            app.Image7.Position = [-10 8 150 66];
            app.Image7.ImageSource = fullfile(pathToMLAPP, 'homeButton.png');
